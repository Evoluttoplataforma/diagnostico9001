    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="px-5 py-10 lg:py-16 lg:px-16">
        <div className="max-w-4xl mx-auto prose prose-invert prose-sm lg:prose-base">
          <h1 className="text-2xl lg:text-4xl font-extrabold text-white mb-2">Termos de Uso</h1>
          <p className="text-white/40 text-sm mb-8">Última atualização: 25 de fevereiro de 2026</p>

          <p className="text-white/70">
            Bem-vindo ao site da <strong className="text-white">Templum Consultoria</strong>. Ao acessar e utilizar nosso site e serviços, você concorda com os termos e condições descritos abaixo. Leia atentamente antes de prosseguir.
          </p>

          <h2 className="text-lg lg:text-xl font-bold text-white mt-8">1. Sobre a Templum</h2>
          <p className="text-white/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-white mt-8">2. Uso do Site</h2>
          <p className="text-white/70">Ao utilizar nosso site, você se compromete a:</p>
          ...
          <h2 className="text-lg lg:text-xl font-bold text-white mt-8">3. Diagnóstico e Ferramentas Online</h2>
          <p className="text-white/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-white mt-8">4. Propriedade Intelectual</h2>
          <p className="text-white/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-white mt-8">5. Serviços de Consultoria</h2>
          <p className="text-white/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-white mt-8">6. Garantia de Certificação</h2>
          <p className="text-white/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-white mt-8">7. Limitação de Responsabilidade</h2>
          <p className="text-white/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-white mt-8">8. Comunicações</h2>
          <p className="text-white/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-white mt-8">9. Alterações nos Termos</h2>
          <p className="text-white/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-white mt-8">10. Legislação Aplicável</h2>
          <p className="text-white/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-white mt-8">11. Contato</h2>
          <p className="text-white/70">
