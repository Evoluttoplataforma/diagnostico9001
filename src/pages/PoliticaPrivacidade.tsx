    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <main className="px-5 py-10 lg:py-16 lg:px-16">
        <div className="max-w-4xl mx-auto prose prose-sm lg:prose-base">
          <h1 className="text-2xl lg:text-4xl font-extrabold text-black mb-2">Política de Privacidade</h1>
          <p className="text-black/40 text-sm mb-8">Última atualização: 25 de fevereiro de 2026</p>

          <p className="text-black/70">
            A <strong className="text-black">Templum Consultoria</strong> ("Templum", "nós", "nosso") tem o compromisso de proteger a privacidade e os dados pessoais de seus clientes, parceiros e visitantes. Esta Política de Privacidade descreve como coletamos, utilizamos, armazenamos e protegemos suas informações pessoais, em conformidade com a Lei Geral de Proteção de Dados (LGPD – Lei nº 13.709/2018).
          </p>

          <h2 className="text-lg lg:text-xl font-bold text-black mt-8">1. Dados Coletados</h2>
          <p className="text-black/70">Podemos coletar os seguintes dados pessoais:</p>
          <ul className="text-black/70 space-y-1">
            <li><strong className="text-black/90">Dados de identificação:</strong> nome completo, CPF/CNPJ, cargo e empresa.</li>
            <li><strong className="text-black/90">Dados de contato:</strong> e-mail, telefone e endereço.</li>
            <li><strong className="text-black/90">Dados de navegação:</strong> endereço IP, cookies, páginas acessadas, tempo de permanência e dispositivo utilizado.</li>
            <li><strong className="text-black/90">Dados fornecidos voluntariamente:</strong> informações inseridas em formulários, diagnósticos, pesquisas ou comunicações diretas.</li>
          </ul>

          <h2 className="text-lg lg:text-xl font-bold text-black mt-8">2. Finalidade do Tratamento</h2>
          <p className="text-black/70">Utilizamos seus dados para as seguintes finalidades:</p>
          <ul className="text-black/70 space-y-1">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-black mt-8">3. Base Legal</h2>
          <p className="text-black/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-black mt-8">4. Compartilhamento de Dados</h2>
          <p className="text-black/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-black mt-8">5. Armazenamento e Segurança</h2>
          <p className="text-black/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-black mt-8">6. Direitos do Titular</h2>
          <p className="text-black/70">Nos termos da LGPD, você tem direito a:</p>
          <ul className="text-black/70 space-y-1">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-black mt-8">7. Cookies</h2>
          <p className="text-black/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-black mt-8">8. Alterações nesta Política</h2>
          <p className="text-black/70">
          ...
          <h2 className="text-lg lg:text-xl font-bold text-black mt-8">9. Contato</h2>
          <p className="text-black/70">
